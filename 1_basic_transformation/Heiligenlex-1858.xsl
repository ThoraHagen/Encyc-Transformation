...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="file" select="document('Heiligenlexikon-1858-000.xml')"> </xsl:variable>
    <xsl:variable name="part2" select="document('Heiligenlexikon-1858-002-2.xml')"> </xsl:variable>
